...
namespace BeerShop.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public CartController(IUnitOfWork unitOfWork, IEmailSender emailSender, UserManager<IdentityUser> userManager, IOptions<TwillioSettings> twilioOptions)
        {
        ...
        //authorized company email confirmation
        [HttpPost]
        [ActionName("Index")]
        ...
        //Decrement Item in shoping cart and update session
        ...
        //Remove Item in shoping cart and update session
        ...
        public IActionResult Summary()
        {
            ...
            {
                OrderHeader = new Models.OrderHeader(),
                ListCart = _unitOfWork.ShoppingCart.GetAll(c=>c.ApplicationUserId==claim.Value, includePoreperties:"Product")
            };

            ShoppingCartVM.OrderHeader.ApplicationUser = _unitOfWork.ApplicationUser.GetFirstOrDefault(c => c.Id == claim.Value, includePoreperties: "Company");
        ...
        public IActionResult SummeryPost(string stripeToken)
        {
            ...
            ShoppingCartVM.ListCart = _unitOfWork.ShoppingCart.GetAll(c => c.ApplicationUserId == claim.Value, includePoreperties:"Product");
        ...
        {
            //Twilio API integration for order confirmation (Sends sms)
            OrderHeader orderHeader = _unitOfWork.OrderHeader.GetFirstOrDefault(u => u.Id == id);
            TwilioClient.Init(_twilioOptions.AccountSid, _twilioOptions.AuthToken);
            try
            {
                var message = MessageResource.Create(
                    body: "Order Placed On Beer Shop, Your Order ID:" + id,
